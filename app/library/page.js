      ...
      <section className={styles.features}>
        ...
        <div className={styles.featureGrid}>
          ...
          <div className={styles.feature}>
            ...
            <p>Photos automatically deleted within 1 hour. HTTPS encryption. No data retention.</p>
          </div>
      ...
      <section className={styles.faq}>
        ...
        <div className={styles.faqGrid}>
          ...
          <details className={styles.faqItem}>
            ...
            <p>All photos are processed securely via HTTPS and automatically deleted within 1 hour. We never store, sell, or reuse uploads.</p>
          </details>
